---
layout: post
title: "KGP 2.3.20 vs 2.3.10"
date: 2026-03-17
report_link: /Telltale/reports/experiment_results_20260317002315.html
summary: " 
...
- **Top Time-consuming Tasks:**
  - `:app:app:mergeExtDexDebug`: Variant A: 12.288s, Variant B: 12.247s
  - `:app:app:hiltJavaCompileDebug`: Variant A: 4.908s, Variant B: 4.851s
  - `:app:app:mergeDebugResources`: Variant A: 4.296s, Variant B: 4.518s
  - **Significant Variation:** `:app:app:mergeDebugResources` shows a noticeable increase in build time in Variant B by 0.222s (5.17%).

### 3. Statistical Patterns
- Tasks such as `:app:app:mergeDebugResources` and `:app:app:mergeExtDexDebug` show a trend where Variant B tends to have slightly higher execution times, particularly noticeable at the P90 percentile.
